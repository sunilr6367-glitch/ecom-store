...
const craftCards = [
  {
    ...
    copy: 'Understand the layered stitch language behind Store quilted pieces.',
    href: '/about/kantha',
  },
  {
    icon: Shirt,
...
const faqItems = [
  {
    ...
    copy: 'Store ships from Jaipur, Rajasthan, India.',
  },
  {
    icon: HelpCircle,
  ...
  },
  {
    ...
    copy: 'Eligible exchange and return support is handled through the Store returns flow.',
  },
  {
    icon: MessageCircle,
