...
export const metadata: Metadata = buildBasicPageMetadata({
  title: 'Bestsellers | Store',
  description:
    'Shop the most loved Store pieces, curated from bestselling products and admin-managed merchandising tags.',
  path: '/bestsellers',
  image: '/images/home/collection-bridal.jpg',
  keywords: ['bestsellers', 'most loved', 'store bestsellers'],
});
