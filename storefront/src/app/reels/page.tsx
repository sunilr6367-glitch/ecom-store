...
export const metadata: Metadata = buildBasicPageMetadata({
  title: 'Watch & Buy Shoppable Reels | Store',
  description:
    'See Store ethnic wear in motion. Watch shoppable reels for drape, fit, styling inspiration, and quick product discovery.',
  path: '/reels',
