...
export const metadata: Metadata = buildBasicPageMetadata({
  title: 'Kantha Craft | Store',
  description: 'A short guide to Kantha-inspired quilting and stitched textile craft in Store handmade pieces.',
  path: '/about/kantha',
});
    ...
    <>
      ...
      >
        <ImageTextSplit
          ...
          imageAlt="Kantha-inspired Store jacket with visible embroidery"
          ...
          body={
            <>
              ...
              <p>
                At Store, Kantha informs the way we think about quilting,
        ...
        <CraftStorySection eyebrow="Heritage" title="Not machine-perfect, deliberately human">
          ...
          <p>
            That human texture is central to Store&apos;s idea of luxury: not
