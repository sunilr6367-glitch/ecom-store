...
export const metadata: Metadata = buildBasicPageMetadata({
  title: 'Terms of Service | Store Handmade - India',
  description:
    "Read Store's Terms of Service. Covers orders, payments, shipping, returns, intellectual property and your rights as a buyer in India and internationally.",
  path: '/pages/terms-of-service',
  keywords: ['Store terms of service', 'Store terms', 'Store payments'],
});
...
These Terms of Service ("Terms") govern your use of store.com and any purchase you make from Store. By placing an order or browsing this website, you agree to these Terms in full. If you do not agree, please do not use this website.

---

### 1. About Us

Store is a handmade textile and clothing brand based in Jaipur, Rajasthan, India. We design and produce kantha quilts, block-print clothing, artisan bags, and related goods, most of which are made to order or in small batches by skilled artisans.
...
Every item sold on Store is handmade or hand-finished. This means:
...
You may cancel an order on the same business day, before dispatch. To request a cancellation, email support@example.com with your order number in the subject line.
...
Remote or non-serviceable areas may take longer. Tracking information is shared once your order is dispatched. You can also track your order at store.com/track.
...
Email support@example.com within 15 days of delivery with your order number and clear photos of the issue. Once approved, we will share the return address and instructions. Please do not return items without receiving approval first.
...
All content on store.com — including product photographs, design artwork, brand name, logo, copy, and print patterns — is the property of Store. You may not reproduce, copy, or distribute any content from this website without prior written permission. Sharing product links or images for personal, non-commercial reference is permitted.

---

### 9. Limitation of Liability

Store's liability for any claim arising from a purchase is limited to the value of the order in question. We are not liable for losses caused by events outside our control, including carrier delays, customs clearance holds, force majeure events, or payment gateway failures.
...
export default function TermsOfServicePage() {
  return (
    <StaticPolicyPage
      ...
      path="/pages/terms-of-service"
      description="Read Store's Terms of Service for orders, payments, shipping, returns, intellectual property, and buyer rights."
      content={content}
    />
  );
}
