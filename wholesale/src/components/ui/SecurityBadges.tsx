...
export function PaymentIcons({ className = '' }: { className?: string }) {
  return (
    <div className={`flex items-center justify-center gap-[var(--ds-space-xs)] ${className}`}>
      {/* Visa */}
      <div className="flex h-8 w-12 items-center justify-center rounded border border-border-subtle bg-[var(--ds-surface-paper)]">
        <span className="text-body-xs text-[var(--ds-info-text)] font-bold italic">
          VISA
        </span>
      </div>
      ...
      {/* Amex */}
      <div className="flex h-8 w-12 items-center justify-center rounded border border-border-subtle bg-[var(--ds-surface-paper)]">
        <span className="text-body-xs text-[var(--ds-info-text)] font-bold">
          AMEX
        </span>
      </div>

      {/* PayPal */}
      <div className="flex h-8 w-14 items-center justify-center rounded border border-border-subtle bg-[var(--ds-surface-paper)]">
        <span className="text-body-xs text-[var(--ds-info-text)] font-bold">
          PayPal
        </span>
      </div>
